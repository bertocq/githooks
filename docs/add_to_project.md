...
```bash
git subtree add --prefix=.githooks git@github.com:rubiconmd/githooks.git master --squash
```
...
```bash
git subtree pull --prefix=.githooks git@github.com:rubiconmd/githooks.git master --squash
```
